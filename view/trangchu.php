...
<body>
      <div class="container">
        ...
        <div class="row mb-3 mt-3">
            <div class="col-md-3">
              <div class="card">
                  <img src="../img/hs1.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Samsung Galaxy S22 5G 128GB</h5>
                    <p class="card-text">11.990.000Đ</p>
            ...
            <div class="col-md-3">
              <div class="card">
                  <img src="../img/hs2.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Honor X8A 8GB-128GB</h5>
                    <p class="card-text">3.990.000Đ</p>
                    <a href="#" class="btn btn-primary">Mua ngay</a>
                    <a href="#" class="btn btn-primary">Thêm vào giỏ</a>
                  </div>
              </div>
            ...
            <div class="col-md-3">
              <div class="card">
                  <img src="../img/hs3.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Xiaomi 13 Lite 8GB-128GB</h5>
                    <p class="card-text">7.990.000Đ</p>
                    <a href="#" class="btn btn-primary">Mua ngay</a>
                    <a href="#" class="btn btn-primary">Thêm vào giỏ</a>
                  </div>
              </div>
            ...
            <div class="col-md-3">
              <div class="card">
                  <img src="../img/hs4.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
                    <h5 class="card-title">Samsung Galaxy Tab A8 WiFi</h5>
                    <p class="card-text">4.790.000Đ</p>
                    <a href="#" class="btn btn-primary">Mua ngay</a>
                    <a href="#" class="btn btn-primary">Thêm vào giỏ</a>
                  </div>
              </div>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="card">
                <img id="h1" src="../img/hs5.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                  <h5 class="card-title">samsung-galaxy-s22 G5 128GB</h5>
                  <p class="card-text">11.990.000Đ</p>
                  <a href="#" class="btn btn-primary">Mua ngay</a>
                  <a href="#" class="btn btn-primary">Thêm vào giỏ</a>
                </div>
          ...
          <div class="col-md-3">
            <div class="card">
                <img  id="h2" src="../img/hs6.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                  <h5 class="card-title">OPPO Reno8 T 4G 256GB</h5>
                  <p class="card-text">6.990.000Đ</p>
                  <a onclick="" href="#" class="btn btn-primary">Mua ngay</a>
                  <a href="#" class="btn btn-primary">Thêm vào giỏ</a>
                </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="card">
                <img id="h3" src="../img/hs7.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                  <h5 class="card-title">Xiaomi Redmi Note 12 4GB-128GB</h5>
                  <p class="card-text">4.290.000Đ</p>
                  <a href="#" class="btn btn-primary">Mua ngay</a>
                  <a href="#" class="btn btn-primary">Thêm vào giỏ</a>
                </div>
            </div>
          ...
          <div class="col-md-3">
            <div class="card">
                <img id="h4" src="../img/hs8.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                  <h5 class="card-title">Samsung Galaxy A23 5G </h5>
                  <p class="card-text">5.190.000Đ</p>
                  <a href="#" class="btn btn-primary">Mua ngay</a>
                  <a href="#" class="btn btn-primary">Thêm vào giỏ</a>
                </div>
            </div>
        ...
        <footer class="text-center text-lg-start bg-light text-muted">
          <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
            ...
            <div class="me-5 d-none d-lg-block">
              <span>www.bandienthoai.id.vn</span>
            </div>
          </section>
          <section class="">
